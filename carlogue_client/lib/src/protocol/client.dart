...
import 'package:carlogue_client/src/protocol/greetings/greeting.dart'
    as _ib8y6ntm;
...
class EndpointGreeting extends _isc.EndpointRef {
  ...
  _ida.Future<_ib8y6ntm.Greeting> hello(String name) =>
      caller.callServerEndpoint<_ib8y6ntm.Greeting>(
        'greeting',
        'hello',
        {'name': name},
      );
